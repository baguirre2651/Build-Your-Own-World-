...
public class Tileset implements Serializable {
    ...
    public static final byow.TileEngine.TETile WALL = new TETile('#',
            new Color(216, 128, 128), Color.darkGray,
            "wall");
    public static final byow.TileEngine.TETile FLOOR = new TETile('·',
            new Color(128, 192, 128), Color.black,
            "floor");
    public static final byow.TileEngine.TETile NOTHING = new TETile(' ', Color.black, Color.black,
            "nothing");
